  ...
  return (
    ...
    <Page>
      <Header style={{ position: 'relative', textAlign: 'center' }}>
        <StyledImage src="/images/logoWithText.png" alt="Mozart illustration" width={5550} height={500} />
        <div style={{ position: 'absolute', bottom: '0', left: '50%', transform: 'translate(-50%, 0)', color: 'white' }}>
          <Heading as="h1" size="xxl" color="secondary" mb="24px">
            {TranslateString(999, 'Farms')}
          </Heading>
          <Heading size="lg" color="text">
            {TranslateString(999, 'Stake Liquidity Pool (LP) tokens to Bank.')}
          </Heading>
        </div>
      </Header>
